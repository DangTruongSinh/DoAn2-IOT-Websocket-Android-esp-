...
CREATE TABLE `thietbi` (
  ...
  `den1` tinyint(1) DEFAULT NULL,
  `den2` tinyint(1) DEFAULT NULL,
  `quat` tinyint(1) DEFAULT NULL,
...
INSERT INTO `thietbi` VALUES (1,1,1,1,0,'28');
...
-- Dump completed on 2019-11-04 10:03:16
